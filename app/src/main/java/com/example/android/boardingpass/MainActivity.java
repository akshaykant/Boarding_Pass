...
public class MainActivity extends AppCompatActivity {
    ...
    //TASK (2.3) Create a data binding instance called mBinding of type ActivityMainBinding
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TASK (2.4) Set the Content View using DataBindingUtil to the activity_main layout
        ...
        */
        ...
        // TASK (2.5) Load a BoardingPassInfo object with fake data using FakeDataUtils
        BoardingPassInfo fakeBoardingInfo = FakeDataUtils.generateFakeBoardingPassInfo();

        // TASK (2.9) Call displayBoardingPassInfo and pass the fake BoardingInfo instance
        displayBoardingPassInfo(fakeBoardingInfo);
    }

    private void displayBoardingPassInfo(BoardingPassInfo info) {

        // TASK (2.6) Use mBinding to set the Text in all the textViews using the data in info
        mBinding.textViewPassengerName.setText(info.passengerName);
        // TASK (3.7) Use the flightInfor attribute in mBinding below to get the appropiate text Views
        ...
        // TASK (2.7) Use a SimpleDateFormat formatter to set the formatted value in time text views
        ...
        // TASK (2.8) Use TimeUnit methods to format the total minutes until boarding
        ...
        // TASK (3.8) Use the boardingInfo attribute in mBinding below to get the appropiate text Views
